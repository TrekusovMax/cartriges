...
import { AddPrinterImage } from '@/features/printer/add-printer-image'
...
import { PrinterForm } from '@/entities/printer/ui/printer-form'
  ...
  return (
    <>
      <PrinterForm
        ...
        setCheckedColorField={setCheckedColorField}
      />
        ...
        <Flex vertical gap="middle" align="center" style={{ width: '100%' }}>
          ...
          <Flex align="center" justify="space-between">
            <Space>
              <Button
                disabled={
                  (fileUpload || imageSelected.current) && !Object.keys(errors).length
                    ? false
                    : true
                }
                type="primary"
